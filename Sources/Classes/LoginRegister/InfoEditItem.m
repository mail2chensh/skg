...
#define IEI_TopMarginOfLabel 5
#define IEI_HeightOfLabel 30
#define IEI_WidthOfLabel 80
...
- (id)initWithFrame:(CGRect)frame model:(InfoEditModel*)model
{
    ...
    if (self) {
        ...
        //
        _textField = [[UITextField alloc] initWithFrame:CGRectMake(_titleLabel.right + IEI_LeftMarginOfLabel / 3, _titleLabel.top, self.width - _titleLabel.width - IEI_LeftMarginOfLabel * 3, _titleLabel.height)];
